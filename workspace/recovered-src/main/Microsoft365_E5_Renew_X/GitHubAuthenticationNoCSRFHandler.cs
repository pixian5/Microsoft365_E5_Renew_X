...
public class GitHubAuthenticationNoCSRFHandler : GitHubAuthenticationHandler
{
	public GitHubAuthenticationNoCSRFHandler(IOptionsMonitor<GitHubAuthenticationOptions> options, ILoggerFactory logger, UrlEncoder encoder, ISystemClock clock)
	{
