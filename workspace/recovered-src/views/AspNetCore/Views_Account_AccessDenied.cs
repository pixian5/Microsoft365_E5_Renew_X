...
[RazorSourceChecksum("SHA1", "a73b50c8d072ae0626d7ab5f0de2d74c1ca4d817", "/Views/Account/AccessDenied.cshtml")]
...
public class Views_Account_AccessDenied : RazorPage<dynamic>
{
	[RazorInject]
	...
	{
		WriteLiteral("\r\n");
		base.ViewBag.Title = Lang.Get("拒绝访问");
		WriteLiteral("\r\n\r\n\r\n\r\n\r\n\r\n<h1 class=\"text-danger\"><b>拒绝访问</b></h1>\r\n<h3 class=\"text-danger\">您没有权限访问该内容！！！</h3>\r\n");
	}
}
